...
export const DEFAULT_SERVER_PROXY_LISTEN_HOST = '0.0.0.0';
...
export const DEFAULT_NATIVE_RUNTIME_VERSION = '1.14.0-r5';
export const DEFAULT_NATIVE_SINGBOX_VERSION = '1.14.0';
export const DEFAULT_NATIVE_ABI_VERSION = 2;
export const DEFAULT_CORE_RUNTIME_MODE = 'embedded';
export const CORE_RUNTIME_MODES = ['embedded'];
...
export const RULESET_KINDS = ['builtin', 'custom', 'remote'];
