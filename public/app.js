...
const systemProxyModeSelect = document.querySelector('#system-proxy-mode-select') || document.querySelector('.system-proxy-mode');
...
bindRoutingEvents({
  ...
  openRoutingRemoteRulesetModal: (ruleset) => routingController.openRoutingRemoteRulesetModal(ruleset),
  routingRuleModalAction,
  routingRuleModalNode,
  getNodeGroups: () => nodeGroupsController.getNodeGroups(),
  getNodeGroupDisplayName: (group) => nodeGroupsController.getNodeGroupDisplayName(group),
